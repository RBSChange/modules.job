<?php
class job_SpontaneousCandidacyHandlingView extends f_view_BaseView
{
	/**
	...
	public function _execute($context, $request)
	{
		...
		try
		{
			...
			$acceptNotif = $notificationService->getNotificationByCodeName('modules_job/spontaneousCandidacyAccepted');
			$refuseNotif = $notificationService->getNotificationByCodeName('modules_job/spontaneousCandidacyRefused');
